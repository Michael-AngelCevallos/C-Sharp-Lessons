...
//===================================================================================================        // PART OF CLASSES LESSON FROM BELOW
 ...
 //=================================================================================================
        // OBJECTS - AN INSTANCE OF A CLASS
                    ...
                    // Example, look around you. you are surrouded by objects. Monitor, mouse , tv, printer. We can use code to mimic real world objects. The can have fields(charateristics- describes what an object has) and methods(actions- what an objec t c an do)
        }
    }
